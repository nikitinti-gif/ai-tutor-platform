...
TASK27_REMEDIATION = {
    ...
    "programming.medoid_minimum": {
        ...
        "control_prompt": "Контроль: суммы A=14, B=11, C=17. Какой медоид выбрать? Ответь буквой A, B или C.",
        "control_answers": ("B", "Б", "11"),
        "retest_prompt": "Перенос: суммы A=21, B=16, C=19. Какой медоид оптимален? Ответь буквой A, B или C.",
        "retest_answers": ("B", "Б", "16"),
        "verification_prompt": "Независимая проверка: суммы A=18, B=23, C=15. Какой медоид оптимален? Ответь буквой A, B или C.",
